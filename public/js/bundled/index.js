...
if (signupForm) signupForm.addEventListener('submit', (e)=>{
    ...
    _signupJs.signup(name, email, password, passwordConfirm);
});
...
if (bookBtn) bookBtn.addEventListener('click', (e)=>{
    ...
    _stripeJs.bookTour(tourId);
});

},{"@babel/polyfill":"dTCHC","./mapbox.js":"3zDlz","./login.js":"7yHem","./signup.js":"fNY2o","./updateSettings.js":"l3cGY","./stripe.js":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1IjoiZ293dGhhbTEzIiwiYSI6ImNsMnB1M2FmeDA1emgzanBiMnlycjAxcGgifQ.nPQCFHtsZoeZ2OCXSc3MTg';
...
const signup = async (name, email, password, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === 'success') {
            _alert.showAlert('success', 'Signed up successfully');
            window.setTimeout(()=>{
                location.assign('/');
            }, 1500);
        }
...
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const stripe = Stripe('pk_test_51Kw1qiSAvdqBycU32HL5mjFKCZ9ByQBsHSgjOVJNqOIrYgAy4J4fYtWDRPPC1u1z28o9hHfiV7FXq9ubeOzPmwlQ00BWL6u6jl');
...
},{"./alert":"kxdiQ","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8cMMN","f2QDv"], "f2QDv", "parcelRequire11c7")
